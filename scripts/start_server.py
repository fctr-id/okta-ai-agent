...
if __name__ == "__main__":
    ...
    if args.no_https:
        ...
        command = f"venv\\Scripts\\python -m uvicorn src.api.main:app --reload --host {args.host} --port {args.port} --log-level {args.log_level}"
        run_command(command)
    else:
        ...
        # Run with HTTPS
        command = (
            f"venv\\Scripts\\python -m uvicorn src.api.main:app --reload --host {args.host} "
